...
void evolution (Array<double, 2> sitefreq, Array<int, 2> codon,Array<int, 2> seq_orig_sar,Array<int, 2> &seq_sar,Array<int, 2> &seq_sar1,Array<int, 2> &seq_sar2,Array<int, 2> &seq_evo_sar,Array<int, 2> &seq_evo_sar1,Array<int, 2> &seq_evo_sar2, int *mutation_number_sar, int *mutation_number_sar1, int *mutation_number_sar2, int m_loci_sar,  int *mutation_location_sar,int seq_length,int interval,int day,int duplic,double selections)
{
    ...
    if (m_number_sar>0)
    {
        ...
        selection(m_number_sar, seq_sar, mutation_temp,codon,selections);//selection
    ...
    if (m_number_sar1>0)
    {
        ...
        selection(m_number_sar1, seq_sar1, mutation_temp,codon,selections);//selection
    ...
    if (m_number_sar2>0)
    {
        ...
        selection(m_number_sar2, seq_sar2, mutation_temp,codon,selections);//selection
