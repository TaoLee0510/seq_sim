...
void extral_results(Array<double, 3> SA_out_temp, Array<double, 3> All_out_temp,Array<double, 3> &SA_out,Array<double, 3> &All_out,int D, int duplic)
{
    for (int j=1;j<=D;j++)
    {
        ...
        SA_out(12,j,duplic)=mean(SA_out_temp(8,j,all));
        double sum5=SA_out(12,j,duplic)+SA_out(4,j,duplic)+SA_out(5,j,duplic);
        if (sum5==0)
        {
            SA_out(13,j,duplic)=0;
        }
        else
        {
        ...
        double sum6=SA_out(14,j,duplic)+SA_out(7,j,duplic)+SA_out(8,j,duplic);
        if (sum6==0)
        {
            SA_out(15,j,duplic)=0;
        }
        else
        {
        ...
        All_out(12,j,duplic)=mean(All_out_temp(8,j,all));
        sum5=All_out(12,j,duplic)+All_out(4,j,duplic)+All_out(5,j,duplic);
        if (sum5==0)
        {
            All_out(13,j,duplic)=0;
        }
        else
        {
        ...
        sum6=All_out(14,j,duplic)+All_out(7,j,duplic)+All_out(8,j,duplic);
        if (sum6==0)
        {
            All_out(15,j,duplic)=0;
        }
        else
        {
